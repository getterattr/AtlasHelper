...
> Status: v1 design locked, implementation not yet started. See `.claude/docs/internal/context.md` for scope and the blocking spike.
...
Setup instructions will be added once v1 ships.
